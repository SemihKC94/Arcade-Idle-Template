...
#pragma warning disable IDE0044 // Salt okunur değiştirici ekle
        private Action internalOnMouseDownFunc, internalOnMouseEnterFunc, internalOnMouseExitFunc;

        public Action InternalOnMouseDownFunc { get => internalOnMouseDownFunc; set => internalOnMouseDownFunc = value; }
        public Action InternalOnMouseEnterFunc { get => internalOnMouseEnterFunc; set => internalOnMouseEnterFunc = value; }
        public Action InternalOnMouseExitFunc { get => internalOnMouseExitFunc; set => internalOnMouseExitFunc = value; }
#pragma warning restore IDE0044 // Salt okunur değiştirici ekle
