...
namespace SKC.Utils
{
    ...
    public class UI_Sprite
    {
        ...
        {
            UI_Sprite uiSprite = new UI_Sprite(GetCanvasTransform(), SKC_Assets.i.s_White, anchoredPosition, size, color);
        ...
        {
            rectTransform = SKC_Utils.DrawSprite(sprite, parent, anchoredPosition, size, "UI_Sprite");
