...
namespace SKC.Utils
{
    ...
    public class World_Bar
    {
        ...
        {
            SKC_Utils.CreateWorldSprite(transform, "Outline", SKC_Assets.i.s_White, new Vector3(0, 0), localScale + new Vector3(outline.size, outline.size), sortingOrder, outline.color);
        }
        private void SetupBackground(Color backgroundColor, Vector3 localScale, int sortingOrder)
        {
            background = SKC_Utils.CreateWorldSprite(transform, "Background", SKC_Assets.i.s_White, new Vector3(0, 0), localScale, sortingOrder, backgroundColor).transform;
        }
        private void SetupBar(Color barColor, Vector3 localScale, int sortingOrder)
        {
            ...
            Transform barIn = SKC_Utils.CreateWorldSprite(bar, "BarIn", SKC_Assets.i.s_White, new Vector3(localScale.x / 2f, 0), localScale, sortingOrder, barColor).transform;
        }
