...
namespace SKC.Utils
{
    public class Button_UI : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        public Button_UI(Action internalOnPointerEnterFunc, Action internalOnPointerExitFunc, Action internalOnPointerClickFunc)
        {
            this.internalOnPointerEnterFunc = internalOnPointerEnterFunc;
            this.internalOnPointerExitFunc = internalOnPointerExitFunc;
            this.internalOnPointerClickFunc = internalOnPointerClickFunc;
        }
