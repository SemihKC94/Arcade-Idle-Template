...
/// Replace tool window.
/// </summary>
public class SKC_ReplaceToolWindow : EditorWindow
{
    // Data store for replace tool.
    SKC_ReplaceData data;
    ...
    [MenuItem("SKC/Replace with Prefab")]
    /// <summary>
    ...
    public static void ShowWindow()
    {
        ...
        var window = GetWindow<SKC_ReplaceToolWindow>();
    ...
    private void OnGUI()
    {
        ...
        // Space.
        EditorGUILayout.Separator();
        EditorGUILayout.LabelField("Created by Semih Kubilay");
    ...
    private void InitDataIfNeeded()
    {
        ...
        if (!data)
        {
            data = ScriptableObject.CreateInstance<SKC_ReplaceData>();
            serializedData = null;
        }
